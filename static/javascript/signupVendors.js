// DEBUG 
console.log('This program was written by Mbonu Chinedum'); 
    ...
    else 
    {
        ...
        if ( email && password ) 
        {
            ...
            .done((data, textStatus, request) =>
            {
                ...
                // If the vendors are registered successfully, redirect the 
                // vendor user to the login page 
                ...
                // If the vendor is registered on the server
                else if ( data.message === "registered_user" )
                {
                    // 
                    alert(`The user with email address\n${email}\nis registred`); 
                    document.location.href = "/signin"; 
                }
